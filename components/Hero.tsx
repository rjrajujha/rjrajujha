...
import MagicButton from './ui/MagicButtont'
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl ld:max-w-[60vw] flex flex-col items-center justify-center">
          ...
          <TextGenerateEffect
            ...
            words="Turning Ideas into Vibe-worthy Experiences"
          />
          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">Hey, I&apos;m Raju, your Go-To Dev</p>
       <a href="#about">
        <MagicButton 
        title="Show my Work"
